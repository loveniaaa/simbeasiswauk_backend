...
public class MajorSpecification {
    ...
    public Specification<Major> search(String searchByCode, String searchByName){
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            if (!StringUtil.isBlank(searchByCode)){
                ...
                Predicate code = criteriaBuilder.like(criteriaBuilder.lower(root.get("majorCode")), "%" + searchByCode.toLowerCase() + "%");
