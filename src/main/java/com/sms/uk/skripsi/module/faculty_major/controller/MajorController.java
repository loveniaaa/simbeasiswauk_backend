...
import com.sms.uk.skripsi.module.faculty_major.services.impl.MajorServiceImpl;
...
@Tag(name = "Major Management")
public class MajorController {

    private final MajorServiceImpl service;
    private final MajorMapper mapper;

    @PostMapping("/create")
    @Operation(summary = "Create major")
    public ResponseEntity<Object> create(@Valid @RequestBody MajorRequest request){
    ...
    public ResponseEntity<Object> update(@Valid @RequestBody MajorRequest request){
    ...
    @GetMapping("/get")
    @Operation(summary = "Paging Major")
    ...
    @GetMapping("/detail")
    @Operation(summary = "Detail major")
